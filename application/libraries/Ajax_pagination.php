...
class Ajax_pagination{
    ...
    var $last_link       = '&raquo;';
    var $uri_segment     = '';
    var $full_tag_open   = '<ul class="flat-pagination">';
    var $full_tag_close  = '</ul>';
    var $first_tag_open  = '<a class="page-numbers">';
    var $first_tag_close = '</a>';
    var $last_tag_open   = '<a class="page-numbers">';
    var $last_tag_close  = '</a>';
    var $cur_tag_open    = '<span aria-current="page" class="page-numbers current">';
    var $cur_tag_close   = '</span>';
    var $next_tag_open   = '<a class="page-numbers next">';
    var $next_tag_close  = '</a>';
    var $prev_tag_open   = '<a class="page-numbers prev">';
    var $prev_tag_close  = '</a>';
    var $num_tag_open    = '<a class="page-numbers">';
    var $num_tag_close   = '</a>';
    var $target          = '';
    var $anchor_class    = '';
    var $show_count      = true;
