...
class paytabs {
    ...
    function payments($merchant_email, $secret_key) {
    ...
    function create_pay_page($values) {
        $values['merchant_email'] = 'gm@yellostack.com';
        $values['secret_key'] = 'XPEgOOuGcs2B7yWrYxYk9NdSNbwdTQOQGs7ugCbs4e4cM0EKxD4Hqhzet5snWgeCIl6ZXis2wwfiwT34w8LXpkbTqDgmTvYCR5BO';
      ...
      return json_decode($this->runPost(PAYPAGE_URL, $values));
        ...
        //return $this->runPost(PAYPAGE_URL, $values);
    }
