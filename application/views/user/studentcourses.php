...
<h4><?php echo $this->Admin_model->translate("Registered Courses") ?> </h4>
</div>
...
<table class="footable-details table table-striped table-hover toggle-circle">
  ...
  <thead>
    ...
    <th><?php echo $this->Admin_model->translate("Schedule") ?></th>
    <th><?php echo $this->Admin_model->translate("Confirmation Status") ?></th>
    <th><?php echo $this->Admin_model->translate("Instructor") ?></th>
    <th><?php echo $this->Admin_model->translate("Payment") ?></th>
        <th><?php echo $this->Admin_model->translate("Instructor Updates") ?></th>
...
if($payment->status=='success'){
  ...
  <a class="btn btn-warning" href="<?php echo $payment->paymentlink ?>"><?php echo $this->Admin_model->translate("Click here to Pay") ?>  </a>
...
<?php $this->db->where('schedule_id',$scheduledet->id);
  $updates = $this->db->get('instructor_updates')->result_array();
  ...
  <a class=" btn btn-info " href="javascript:void(0)" onclick="viewhistory('<?php echo  $scheduledet->id ?>')" >Instructor Updates</a> 
