...
<h4 style="text-align: center;"><?php echo $this->Admin_model->translate("Student Register") ?> </h4>
</p>
...
<div class="tutor-form-group">
<label>
<?php echo $this->Admin_model->translate("Phone Number") ?>            </label>

<input type="text" name="phoneno" class="tutor_user_name" value="" placeholder="Phone Number">
</div>
</div>
...
<button type="submit" name="tutor_register_student_btn" value="register" class="tutor-button btn-block save"><?php echo $this->Admin_model->translate("Register") ?></button>
</div>
</div>
</div>
...
<?php echo $this->Admin_model->translate("Already registered ? Click here to Login") ?>     </a>
</p>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content" >
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" id="close" data-dismiss="modal"><?php echo $this->Admin_model->translate("Close") ?></button>
        </div>
      </div>
</div>
</div>
...
<script src="<?php echo base_url();?>assets/plugin/modal/remodal/remodal.min.js"></script>
...
jQuery('#usr_id').html(JSON.result);  
...
$('#dataModal').on('click', '#close', function() {
