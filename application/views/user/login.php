...
<h4 style="text-align: center;"><?php echo $this->Admin_model->translate("Student Login") ?></h4>
</p>
...
<form method="POST"  id="form-slider" action="<?php echo base_url();?>user/userlogin" enctype="multipart/form-data">
...
<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary" value="<?php echo $this->Admin_model->translate("Log In") ?> " />
