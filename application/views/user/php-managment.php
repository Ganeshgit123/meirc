...
<?php echo  $coursedet->duration ?> Days
...
<div class="row course_bak">
<div class="col-2 col-md-1">
<input type="radio" <?php if($value['start_date'] < date('Y-m-d')){ echo 'disabled' ;} ?> name="schedule" value="<?php echo $value['id'] ?>">	
</div>
<div class="col-10 col-md-11">
	<span><?php echo $value['type'] .' <br> <i class="far fa-calendar"></i>&nbsp;&nbsp; '. date("d-M-y", strtotime($value['start_date'])) .' @ '.$value['time'].'<br> <i class="fa fa-map-marker"></i>&nbsp;&nbsp; Location : '.$value['location'] ?></span> <br/> 
</div>
</div>
...
<?php if($this->session->userdata('dir')=='rtl'){ ?>
 ...
 <form action="<?php echo base_url()?>user/arabiccontent_enquiry" id="xin-form" method="post">
   ...
   <input class="form-control" id="name" type="hidden" name="courseid" value="<?php echo $coursedet->course_id  ?>">
    ...
    <div class="form-group">
      <label for="name"><?php echo $this->Admin_model->translate("Name") ?></label>
      <input class="form-control" id="name" type="text" name="name">
    </div>
    <div class="form-group">
      <label for="email"><?php echo $this->Admin_model->translate("Email") ?></label>
      <input class="form-control" id="email" type="email" name="email">
    </div>
      <div class="form-group">
      <label for="email"><?php echo $this->Admin_model->translate("Phone No.") ?></label>
    ...
    <input class="btn btn-primary" type="submit" value="Submit" />
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $this->Admin_model->translate("Close") ?></button>
        </div>
      </div>
...
<?php $catid = $coursedet->category_id ;
...
<p class="text-center">
<img class="cat_img" src="<?php echo base_url() ?>uploads/images/<?php echo $category->cat_icon ?>" style="background-color:<?php echo $category->icon_bg_color ?> "></p> 
