...
<li id="menu-item-2704" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2704"><a href="<?php echo base_url();?>user/courses?type=public">Public classes</a></li>
<li id="menu-item-2707" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2707"><a href="<?php echo base_url();?>user/courses?type=inhouse">In-House</a></li>
<li id="menu-item-2705" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2705"><a href="<?php echo base_url();?>user/comingsoon">Self-paced</a></li>
<li id="menu-item-2706" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2706"><a href="<?php echo base_url();?>user/courses?type=virtual">Virtual instructor led  </a></li>
<li id="menu-item-2707" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2707"><a href="<?php echo base_url();?>user/comingsoon">Certified Courses</a></li>
</ul></div></div>
</div>
</div>
</div>
...
<p style="color:white;margin-bottom:5px;">Email: manager@mericsa.com<br>
Phone-no :&nbsp;  +966133412188<br>
...
<a href="index.html">
<img src="<?php echo base_url();?>assets/userassets/2020/10/Group-48.png" alt="My Blog">
</a>
</div>
...
<div class="elementor-widget-container">
<div class="elementor-text-editor elementor-clearfix">
<p class="link"><a href="">Privacy Policy</a>
<a href="">Terms & Condition</a></p>
<p class="link1" style="color:white">© 2021. All rights reserved. &nbsp;&nbsp;<img src="<?php echo base_url();?>assets/userassets/img/card.png" width="150px" height="150px"></p>
