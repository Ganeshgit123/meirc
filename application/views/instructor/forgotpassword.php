...
<form method="POST"  id="form-slider" action="<?php echo base_url();?>instructor/send_mail" enctype="multipart/form-data">
...
<p class="tutor-form-register-wrap">
<a href="<?php echo base_url();?>instructor/login">
...
jQuery.post("<?php echo base_url(); ?>instructor/emailexists",
{
email: email
},
...
jQuery('.save').prop('disabled', false);
//window.location.href="<?php echo base_url();?>instructor/login";
