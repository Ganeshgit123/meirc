...
<div class="box-title row">
    <div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Edit Course") ?></h4></div>
  ...
  <div class="card-content">
        ...
        <?php echo form_open('admin/update_product', $attributes, $hidden);?>
        <div class="form-body">
...
<?php echo $this->Admin_model->select_html('subcategory','id', 'sub_category', 'subcategory_name', 'edit', 'demo-chosen-select form-control required ', $subcategory_id, '', '', ''); ?>
            ...
            <input type="hidden" name="productid" value="<?php echo $id ?>">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Course Name" name="product_name" type="text" value="<?php echo $product_name ?>">
                  </div>
                </div>
            </div>
	...
	<div class="row"> 
           ...
           <!-- <input type="hidden" name="ar_productid" value="<?php echo $id ?>"> -->
               
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="first_name"><?php echo $this->Admin_model->translate("Course Name - Arabic") ?></label>
                    <input class="form-control" placeholder="Course Name" name="ar_product_name" type="text" value="<?php echo $ar_product_name ?>">
                  </div>
                </div>
            </div>
            ...
            <div class="row"> 
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea name="description" id="tinymce" class="form-control" placeholder="Service Description" > <?php echo $description ?> </textarea>
