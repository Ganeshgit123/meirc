...
<div class="box-title row">
    <div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Edit Instructor") ?></h4></div>
    <div class='col-md-6'></div>
    <div class='col-md-2'> 
            <a href="<?php echo base_url(); ?>admin/instructor"><button class="btn btn-warning"><?php echo $this->Admin_model->translate("Instructor List") ?></button></a>
    </div>
</div>
  ...
  <div class="card-content">
        ...
        <?php echo form_open('admin/update_instructor', $attributes, $hidden);?>
        <div class="form-body">
          <div class="row"> 
	...
	$("#xin-form").submit(function(e){
		...
		$.ajax({
			...
			success: function(JSON)
			{
				...
				$('.save').prop('disabled', false);
				window.location.href="<?php echo base_url();?>admin/instructor";
				}
			},
			error: function() 
			{
