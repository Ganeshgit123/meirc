...
<div class="box-content">
        ...
        <div class="form-body">
          <div class="row"> 
             ...
             <select name="type" id="item_type"  class="form-control"  >
                    ...
                    <option value = "Virtual Instructor - Lead"  selected > Virtual Instructor - Lead</option> 
 ...
 <div class="col-md-2">
                <div class="form-group">
                   <label for="first_name"> <?php echo $this->Admin_model->translate("Instructor Assigned Status")?></label><br/>
                  <input type="checkbox" name="" id="assigned"  > <span>Assigned</span>
                  </div>
                </div>

                <div class="col-md-2">
                <div class="form-group">
                   <label for="first_name"> <?php echo $this->Admin_model->translate("Include Old Dates")?></label><br/>
                  <input type="checkbox" name="" id="olddata"   > <span>Include Old Dates</span>
                  </div>
                </div>
</div>
...
$type = $('#item_type').val();
$assigned  = $('#assigned').is(':checked') ;
$olddata  = $('#olddata').is(':checked');
//var xin_table = $('#xin_table').dataTable();

$.ajax({ 
type: "POST",
url: "<?php echo base_url(); ?>"+'admin/schedule_report/',
data: {course:$course,category:$category,subcategory:$subcategory,location:$location,startdate:$startdate,type:$type,assigned:$assigned,olddata:$olddata},
