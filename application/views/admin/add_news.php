...
<div class="box-title row">
    <div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Add News") ?> </h4></div>
  ...
  <div class="card-content">
        ...
        <?php echo form_open('admin/addnews', $attributes, $hidden);?>
        <div class="form-body">
          <div class="row"> 
               
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="first_name"> <?php echo $this->Admin_model->translate("Title") ?></label>
                    <input class="form-control" placeholder="Title" name="news_title" type="text" value="">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="first_name"> <?php echo $this->Admin_model->translate("Image") ?></label>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="first_name"> <?php echo $this->Admin_model->translate(" Description") ?></label>
                     <textarea  class="form-control"  id="tinymce"  name="description" placeholder=" Description"></textarea>
                  </div>
                </div>
