...
<div class="box-title row">
    <div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Add Instructor")?></h4></div>
    <div class='col-md-6'></div>
    <div class='col-md-2'> 
            <a href="<?php echo base_url(); ?>admin/instructor"><button class="btn btn-warning">Instructor List</button></a>
    </div>
</div>
  ...
  <div class="card-content">
        ...
        <?php echo form_open('admin/addinstructor', $attributes, $hidden);?>
        <div class="form-body">
          <div class="row"> 
