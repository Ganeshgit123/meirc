...
<div class="box-title row">
    <div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Edit Sub Category") ?></h4></div>
  ...
  <div class="card-content">
        ...
        <?php echo form_open('admin/update_subcategory', $attributes, $hidden);?>
        <div class="form-body">
            ...
            <input type="hidden" name="subcatid" value="<?php echo $id ?>">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Sub Category Name" name="subcategory_name" type="text" value="<?php echo $subcategory_name ?>">
                  </div>
                </div>
            </div>
