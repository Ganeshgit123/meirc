...
<div class="box-title row">
    <div class='col-md-4'><h4>Add Course</h4></div>
    <div class='col-md-6'></div>
    <div class='col-md-2'> 
            <a href="<?php echo base_url(); ?>admin/products"><button class="btn btn-warning">Course List</button></a>
    </div>
</div>
  ...
  <div class="card-content">
        ...
        <?php echo form_open('admin/addproduct', $attributes, $hidden);?>
        <div class="form-body">

        	<div class="row"> 
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="first_name"><?php echo $this->Admin_model->translate("Course Category") ?> </label>
          	...
          	<div class="row"> 
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    name="product_name" type="text" value="">
                  </div>
                </div>
            </div>
